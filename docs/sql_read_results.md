...
Cohort 2024A has the highest average prereq_score (81.8). This might suggest that 2024A started with stronger pre-work preparation compared to the other cohorts.
...
8 students scored 80 or above. Most are from Jordan, with a couple from Palestine and one from Egypt.
...
Lina Barakat submitted all listed projects (weeks 1–3) on time with consistently high grades (98, 95, 96), which suggests strong consistency and performance.